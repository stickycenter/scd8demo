...
<!-- Content Footer  -->
    <div id="content-footer" class="clearfix">
        <div class="container">
			<div class="row">
				<div class="col-md-6">
					<?php if ($page['content_footer_first']):?>
					<?php print render ($page['content_footer_first']); ?>
					<?php endif; ?>
				</div>
				<div class="col-md-6">
					<?php if ($page['content_footer_second']):?>
					<?php print render ($page['content_footer_second']); ?>
					<?php endif; ?>
				</div>
